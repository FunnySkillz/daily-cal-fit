...
Survey "1" -left- "*" Questionnaire: hat >
Questionnaire "*" -- "*" Question: hat >
Question "*" -left- "1" QuestionType: hat >
Question "1" -- "*" AnswerOption: hat >
AnswerOption "1" -right- "*" ChosenOption
ChosenOption "*" -right- "1" Answer
Answer "*" -up- "1" Transaction
Survey "1" -- "*" Transaction: hat
